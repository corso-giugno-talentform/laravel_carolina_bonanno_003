<div>
    <div class="container mt-5">
        <div class="align-middle gap-2 d-flex justify-content-between">
            ...
            <form class="d-flex" role="search"> {{-- action="{{ route('books.index') }}" method="GET" non servono più --}}

                <div class="input-group">
                    <input name="search" type="search" wire:model.live="search" class="form-control"
                        placeholder="Cerca Libro" aria-label="Cerca Libro">
                    {{-- Non ne ho più bisogno: <button class="btn btn-outline-secondary" type="submit" id="button-addon2">Cerca</button> --}}
                </div>
